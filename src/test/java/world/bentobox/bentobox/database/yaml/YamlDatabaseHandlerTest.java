...
public class YamlDatabaseHandlerTest {
  ...
  public void testLoadObjects()
    throws InstantiationException, IllegalAccessException, InvocationTargetException, ClassNotFoundException, NoSuchMethodException, IntrospectionException {
    ...
    assertTrue(
      list
        .stream()
        .anyMatch(
          i -> i.getOwner().toString().equals("5988eecd-1dcd-4080-a843-785b62419abb")
        )
    );
    ...
    assertTrue(
      list
        ...
        .anyMatch(
          i ->
            i.getMembers().get(UUID.fromString("5988eecd-1dcd-4080-a843-785b62419abb")) ==
            1000
        )
    );
  }
  ...
  public void testLoadObject()
    ...
    assertEquals(
      (Integer) 1000,
      is.getMembers().get(UUID.fromString("5988eecd-1dcd-4080-a843-785b62419abb"))
    );
  }
  ...
  public void testSaveObject()
    ...
    verify(dbConnector)
      .saveYamlFile(anyString(), eq("database/Island"), eq("unique"), isA(Map.class));
  }
   ...
   */
  @Test
  public void testSaveObjectNotDO()
    throws IllegalAccessException, InvocationTargetException, IntrospectionException {
    YamlDatabaseHandler<String> h = new YamlDatabaseHandler<String>(
      plugin,
      String.class,
      dbConnector
    );
  ...
  public void testObjectExists() {
    when(
        dbConnector.uniqueIdExists(eq(Island.class.getSimpleName()), eq(uuid.toString()))
      )
      .thenReturn(true);
