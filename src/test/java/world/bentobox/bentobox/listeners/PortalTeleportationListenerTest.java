...
@PrepareForTest(
  { Bukkit.class, BentoBox.class, User.class, Util.class, BlueprintPaster.class }
)
public class PortalTeleportationListenerTest {
  ...
  public void setUp() throws Exception {
    ...
    when(im.homeTeleportAsync(any(), any()))
    ...
    when(bpm.getBlueprints(any()))
      .thenReturn(Collections.singletonMap("blueprintname", bp));
    // Paster
