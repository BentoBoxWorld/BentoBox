...
public class BentoBoxLocaleTest {
  ...
  public void testGetLanguage() {
    ...
    assertEquals(
      "unknown",
      new BentoBoxLocale(null, new YamlConfiguration()).getLanguage()
    );
  }
  ...
  public void testGetCountry() {
    ...
    assertEquals(
      "unknown",
      new BentoBoxLocale(null, new YamlConfiguration()).getCountry()
    );
  }
  ...
  public void testToLanguageTag() {
    ...
    assertEquals(
      "unknown",
      new BentoBoxLocale(null, new YamlConfiguration()).toLanguageTag()
    );
  }
