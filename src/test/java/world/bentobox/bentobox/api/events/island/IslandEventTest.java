...
public class IslandEventTest {
    ...
    /**
     * Test method for
     * {@link world.bentobox.bentobox.api.events.island.IslandEvent#IslandEvent(world.bentobox.bentobox.database.objects.Island, java.util.UUID, boolean, org.bukkit.Location, world.bentobox.bentobox.api.events.island.IslandEvent.Reason)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link world.bentobox.bentobox.api.events.island.IslandEvent#builder()}.
     */
    @Test
    public void testBuilder() {
        for (Reason reason : Reason.values()) {
            IslandBaseEvent e = IslandEvent.builder().admin(true).blueprintBundle(blueprintBundle)
                    .deletedIslandInfo(deletedIslandInfo).involvedPlayer(uuid).island(island).location(location)
                    .oldIsland(island).protectionRange(120, 100).reason(reason).build();
