...
public class IslandTeamKickCommandTest {
  ...
  public void setUp() throws Exception {
    ...
    AddonDescription desc = new AddonDescription.Builder("main", "name", "version")
    .build();
  ...
  public void testExecuteUnknownPlayer() {
    ...
    assertFalse(
      itl.execute(user, itl.getLabel(), Collections.singletonList("poslovitch"))
    );
  ...
  public void testExecuteNoConfirmation() {
    ...
    verify(user)
      .sendMessage("commands.island.team.kick.success", TextVariables.NAME, "poslovitch");
  }
  ...
  public void testExecuteWithConfirmation() {
    ...
    verify(user)
      .sendMessage(eq("commands.confirmation.confirm"), eq("[seconds]"), eq("0"));
  }
  ...
  public void testTabCompleteNoArgument() {
    ...
    when(island.getRank(any(UUID.class)))
      .thenReturn(
  ...
  public void testTabCompleteWithArgument() {
    ...
    Optional<List<String>> result = ibc.tabComplete(
      user,
      "",
  ...
  public void testTabCompleteWithWrongArgument() {
    ...
    when(island.getRank(any(User.class)))
      .thenReturn(
        RanksManager.COOP_RANK,
        RanksManager.COOP_RANK,
        RanksManager.COOP_RANK,
