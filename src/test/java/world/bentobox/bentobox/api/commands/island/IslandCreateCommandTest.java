...
@PrepareForTest(
  { Bukkit.class, BentoBox.class, NewIsland.class, IslandCreationPanel.class }
)
public class IslandCreateCommandTest {
  ...
  public void setUp() throws Exception {
    ...
    when(user.getTranslation(Mockito.anyVararg()))
  ...
  public void testExecuteUserStringListOfStringThrowException() throws Exception {
    ...
    when(builder.build())
      .thenThrow(new IOException("commands.island.create.unable-create-island"));
    ...
    verify(plugin)
      .logError(
        "Could not create island for player. commands.island.create.unable-create-island"
      );
  }
