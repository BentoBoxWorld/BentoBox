...
public class IslandUnbanCommandTest {
  ...
  public void testUnbanUser() {
    ...
    verify(user)
      .sendMessage(
        "commands.island.unban.player-unbanned",
        TextVariables.NAME,
        targetUser.getName()
      );
    verify(targetUser)
      .sendMessage(
        "commands.island.unban.you-are-unbanned",
        TextVariables.NAME,
        user.getName()
      );
  }
  ...
  public void testCancelledUnban() {
    ...
    verify(targetUser, never())
      .sendMessage("commands.island.unban.you-are-unbanned", "[owner]", user.getName());
  }
