...
public class HiddenCommandTest {
    ...
    /**
     * Test method for
     * {@link world.bentobox.bentobox.api.commands.CompositeCommand#tabComplete(org.bukkit.command.CommandSender, java.lang.String, java.lang.String[])}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link world.bentobox.bentobox.api.commands.CompositeCommand#tabComplete(Player, java.lang.String, java.lang.String[])}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link world.bentobox.bentobox.api.commands.CompositeCommand#showHelp(world.bentobox.bentobox.api.commands.CompositeCommand, world.bentobox.bentobox.api.user.User)}.
     */
    @Test
    public void testShowHelp() {
        ...
        verify(user).sendMessage(eq("commands.help.syntax-no-parameters"), eq("[usage]"), eq("/top"),
                eq(TextVariables.DESCRIPTION), eq("top.description"));
        verify(user).sendMessage(eq("commands.help.syntax-no-parameters"), eq("[usage]"), eq("/top visible"),
                eq(TextVariables.DESCRIPTION), eq("visible.description"));
        verify(user, never()).sendMessage(eq("commands.help.syntax-no-parameters"), eq("[usage]"), eq("/top hidden"),
                eq(TextVariables.DESCRIPTION), anyString());
        verify(user, never()).sendMessage(eq("commands.help.syntax-no-parameters"), eq("[usage]"), eq("/top hidden2"),
                eq(TextVariables.DESCRIPTION), anyString());
