...
public class IslandNearCommandTest {
  ...
  public void testCanExecuteWithArgsShowHelp() {
    ...
    verify(user)
      .sendMessage(eq("commands.help.header"), eq(TextVariables.LABEL), eq("BSkyBlock"));
  }
  ...
  public void testExecuteUserStringListOfStringAllFourPoints() {
    ...
    verify(user)
      .sendMessage(
        eq("commands.island.near.syntax"),
        eq("[direction]"),
        eq("commands.island.near.north"),
  ...
  public void testExecuteUserStringListOfStringUnowned() {
    ...
    verify(user)
      .sendMessage(
        ...
        eq("commands.island.near.north"),
        eq(TextVariables.NAME),
        eq("commands.admin.info.unowned")
      );
    verify(user)
      .sendMessage(
        eq("commands.island.near.syntax"),
