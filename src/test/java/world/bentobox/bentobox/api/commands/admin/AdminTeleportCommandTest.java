...
public class AdminTeleportCommandTest {
  ...
  public void setUp() throws Exception {
    ...
    when(
        user.getTranslation(Mockito.anyString(), Mockito.anyString(), Mockito.anyString())
      )
      .thenAnswer(
        new Answer<String>() {
  ...
  public void testExecuteUserStringListOfStringEmptyArgs() {
    ...
    verify(user)
      .sendMessage(eq("commands.help.header"), eq(TextVariables.LABEL), eq(null));
  }
  ...
  public void testExecuteUserStringListOfStringKnownTargetHasIsland() {
    ...
    verify(user)
      .getTranslation(eq("commands.admin.tp.manual"), eq("[location]"), eq("0 0 0"));
  }
