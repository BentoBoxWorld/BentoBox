...
public class AdminPurgeCommandTest {
  ...
  public void testExecuteUserStringListOfStringNoIslands() {
    ...
    verify(user)
      .sendMessage(eq("commands.admin.purge.purgable-islands"), eq("[number]"), eq("0"));
  }
  ...
  public void testExecuteUserStringListOfStringIslandsFound() {
    ...
    verify(user)
      .sendMessage(eq("commands.admin.purge.purgable-islands"), eq("[number]"), eq("1"));
    verify(user)
      .sendMessage(eq("commands.admin.purge.confirm"), eq("[label]"), eq("bsb"));
  }
  ...
  public void testRemoveIslands() {
    ...
    verify(user)
      .sendMessage(
        eq("commands.admin.purge.see-console-for-status"),
        eq("[label]"),
        eq("bsb")
      );
  }
