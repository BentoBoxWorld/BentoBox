...
public class IslandTeamTrustCommandTest {
    ...
    /**
     * Test method for {@link world.bentobox.bentobox.commands.island.team.IslandTeamTrustCommand#execute(world.bentobox.bentobox.api.user.User, java.lang.String, java.util.List)}.
     */
    @Test
