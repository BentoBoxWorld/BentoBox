...
public class IslandTeamUncoopCommandTest {
    ...
    /**
     * Test method for {@link world.bentobox.bentobox.commands.island.team.IslandTeamUncoopCommand#execute(world.bentobox.bentobox.api.user.User, java.lang.String, java.util.List)}.
     */
    @Test
