...
public class IslandTeamUntrustCommandTest {
    ...
    /**
     * Test method for {@link world.bentobox.bentobox.commands.island.team.IslandTeamUntrustCommand#execute(world.bentobox.bentobox.api.user.User, java.lang.String, java.util.List)}.
     */
    @Test
