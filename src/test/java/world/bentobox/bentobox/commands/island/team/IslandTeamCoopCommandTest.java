...
public class IslandTeamCoopCommandTest {
    ...
    /**
     * Test method for {@link world.bentobox.bentobox.commands.island.team.IslandTeamCoopCommand#execute(world.bentobox.bentobox.api.user.User, java.lang.String, java.util.List)}.
     */
    @Test
