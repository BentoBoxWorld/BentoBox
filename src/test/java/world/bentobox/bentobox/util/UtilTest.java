...
public class UtilTest {
  ...
  public void testGetLocationString() {
    ...
    assertNull(Util.getLocationString("     "));
    Location result = Util.getLocationString(
      "world_name:500:600:700.0:1092616192:1101004800"
    );
  ...
  public void testGetStringLocation() {
    ...
    when(location.getWorld()).thenReturn(world);
    assertEquals(
      "world_name:500:600:700:1092616192:1101004800",
      Util.getStringLocation(location)
    );
  }
  ...
  public void testPrettifyText() {
    assertEquals(
      ...
      Util.prettifyText("HELLO_THERE_THIS_IS_A_TEST")
    );
  ...
  public void testGetOnlinePlayerList() {
    ...
    assertEquals(
      "Online players, not user",
      11,
      Util.getOnlinePlayerList(mock(User.class)).size()
    );
  ...
  public void testRunCommandsConsoleCommandFail() {
    ...
    Bukkit.dispatchCommand(sender, "replace tastybento");
    verify(plugin)
      .logError("Could not execute test command as console: replace tastybento");
  }
}
