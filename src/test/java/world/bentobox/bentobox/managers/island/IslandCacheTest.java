...
public class IslandCacheTest {
  ...
  public void setUp() throws Exception {
    ...
    // IWM
    when(iwm.getDefaultIslandFlags(any()))
      .thenReturn(Collections.singletonMap(flag, 400));
  ...
  public void testGetIslandAtLocation() {
    ...
    when(island.inIslandSpace(Mockito.any(Integer.class), Mockito.any(Integer.class)))
      .thenReturn(true);
    // Set plugin
  ...
  public void testGetMembers() {
    ...
    assertTrue(
      ic.getMembers(world, UUID.randomUUID(), RanksManager.MEMBER_RANK).isEmpty()
    );
    assertFalse(
      ic.getMembers(world, island.getOwner(), RanksManager.MEMBER_RANK).isEmpty()
    );
    assertEquals(
      3,
