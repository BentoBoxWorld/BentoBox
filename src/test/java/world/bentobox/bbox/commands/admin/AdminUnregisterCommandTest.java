...
public class AdminUnregisterCommandTest {
    ...
    /**
     * Test method for {@link world.bentobox.bbox.commands.admin.team.AdminUnregisterCommand#execute(world.bentobox.bbox.api.user.User, java.util.List)}.
     */
    @Test
    ...
    /**
     * Test method for {@link us.world.bentobox.bbox.commands.admin.teams.AdminUnregisterCommand#execute(world.bentobox.bbox.api.user.User, java.util.List)}.
     */
    @Test
