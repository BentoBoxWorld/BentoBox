...
public class AdminRangeSetCommandTest {
    ...
    /**
     * Test method for {@link world.bentobox.bbox.commands.admin.range.AdminRangeSetCommand#execute(world.bentobox.bbox.api.user.User, java.lang.String, java.util.List)}.
     */
    @Test
