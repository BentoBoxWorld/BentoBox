...
public final class Flags {
   ...
   */
  public static final Flag BREAK_BLOCKS = new Flag.Builder(
    "BREAK_BLOCKS",
   ...
   * @since 1.13.0
   */
  public static final Flag BREAK_SPAWNERS = new Flag.Builder(
    "BREAK_SPAWNERS",
    Material.SPAWNER
  )
   ...
   * @since 1.14.0
   */
  public static final Flag BREAK_HOPPERS = new Flag.Builder(
    "BREAK_HOPPERS",
    Material.HOPPER
  )
    .mode(Flag.Mode.EXPERT)
   ...
   */
  public static final Flag PLACE_BLOCKS = new Flag.Builder(
    "PLACE_BLOCKS",
    Material.OAK_PLANKS
  )
    .listener(new PlaceBlocksListener())
    .mode(Flag.Mode.BASIC)
    .build();
   ...
   * @see PlaceBlocksListener
   */
  public static final Flag FROST_WALKER = new Flag.Builder("FROST_WALKER", Material.ICE)
  .build();

  // Block interactions - all use BlockInteractionListener()
  public static final Flag ANVIL = new Flag.Builder("ANVIL", Material.ANVIL)
    .listener(new BlockInteractionListener())
    .mode(Flag.Mode.BASIC)
    .build();
  ...
  public static final Flag BREWING = new Flag.Builder("BREWING", Material.BREWING_STAND)
    .mode(Flag.Mode.ADVANCED)
    .build();
  public static final Flag CONTAINER = new Flag.Builder("CONTAINER", Material.CHEST)
    .mode(Flag.Mode.BASIC)
    .build();
  public static final Flag DISPENSER = new Flag.Builder("DISPENSER", Material.DISPENSER)
    .mode(Flag.Mode.ADVANCED)
    .build();
  public static final Flag DROPPER = new Flag.Builder("DROPPER", Material.DROPPER)
    .mode(Flag.Mode.ADVANCED)
    .build();
  public static final Flag HOPPER = new Flag.Builder("HOPPER", Material.HOPPER)
    .mode(Flag.Mode.ADVANCED)
    .build();
  public static final Flag DOOR = new Flag.Builder("DOOR", Material.OAK_DOOR)
    .defaultSetting(true)
    .mode(Flag.Mode.BASIC)
    .build();
  public static final Flag TRAPDOOR = new Flag.Builder("TRAPDOOR", Material.OAK_TRAPDOOR)
    .defaultSetting(true)
    .mode(Flag.Mode.BASIC)
    .build();
  public static final Flag CRAFTING = new Flag.Builder(
    "CRAFTING",
    Material.CRAFTING_TABLE
  )
    .defaultSetting(true)
    .build();
  public static final Flag ENCHANTING = new Flag.Builder(
    "ENCHANTING",
    ...
    .mode(Flag.Mode.BASIC)
    .build();
  public static final Flag FURNACE = new Flag.Builder("FURNACE", Material.FURNACE)
    .mode(Flag.Mode.BASIC)
    .build();
  public static final Flag GATE = new Flag.Builder("GATE", Material.OAK_FENCE_GATE)
    .mode(Flag.Mode.BASIC)
    .defaultSetting(true)
    .build();
  public static final Flag NOTE_BLOCK = new Flag.Builder(
    "NOTE_BLOCK",
    Material.NOTE_BLOCK
  )
  .build();
  public static final Flag JUKEBOX = new Flag.Builder("JUKEBOX", Material.JUKEBOX)
  .build();
  public static final Flag LEVER = new Flag.Builder("LEVER", Material.LEVER)
    .mode(Flag.Mode.ADVANCED)
    .build();
  public static final Flag BUTTON = new Flag.Builder("BUTTON", Material.OAK_BUTTON)
    .mode(Flag.Mode.ADVANCED)
    .build();
  public static final Flag REDSTONE = new Flag.Builder("REDSTONE", Material.REDSTONE)
    .mode(Flag.Mode.ADVANCED)
    .build();
  public static final Flag SPAWN_EGGS = new Flag.Builder(
    "SPAWN_EGGS",
    Material.COW_SPAWN_EGG
  )
  .build();
  public static final Flag ITEM_FRAME = new Flag.Builder(
    "ITEM_FRAME",
    Material.ITEM_FRAME
  )
    .mode(Flag.Mode.ADVANCED)
   ...
   * @see BreakBlocksListener
   */
  public static final Flag DRAGON_EGG = new Flag.Builder(
    "DRAGON_EGG",
    Material.DRAGON_EGG
  )
  .build();
   ...
   * @see LecternListener
   */
  public static final Flag LECTERN = new Flag.Builder("LECTERN", Material.LECTERN)
    .listener(new LecternListener())
    .build();

  // Entity interactions
  public static final Flag ARMOR_STAND = new Flag.Builder(
    "ARMOR_STAND",
    Material.ARMOR_STAND
  )
    .listener(new EntityInteractListener())
    .mode(Flag.Mode.ADVANCED)
    .build();
  public static final Flag RIDING = new Flag.Builder(
    "RIDING",
   ...
   * @see PlaceBlocksListener
   */
  public static final Flag MINECART = new Flag.Builder("MINECART", Material.MINECART)
    .mode(Flag.Mode.ADVANCED)
    .build();
  /**
   ...
   * @see PlaceBlocksListener
   */
  public static final Flag BOAT = new Flag.Builder("BOAT", Material.OAK_BOAT)
    .mode(Flag.Mode.BASIC)
    .build();
  public static final Flag TRADING = new Flag.Builder("TRADING", Material.EMERALD)
    .defaultSetting(true)
    .mode(Flag.Mode.BASIC)
    .build();
  public static final Flag NAME_TAG = new Flag.Builder("NAME_TAG", Material.NAME_TAG)
    .mode(Flag.Mode.ADVANCED)
    .build();

  // Breeding
  public static final Flag BREEDING = new Flag.Builder("BREEDING", Material.CARROT)
    .listener(new BreedingListener())
    .mode(Flag.Mode.ADVANCED)
    .build();

  // Buckets. All bucket use is covered by one listener
  public static final Flag BUCKET = new Flag.Builder("BUCKET", Material.BUCKET)
    .listener(new BucketListener())
    .mode(Flag.Mode.BASIC)
    .build();
  public static final Flag COLLECT_LAVA = new Flag.Builder(
    "COLLECT_LAVA",
    Material.LAVA_BUCKET
  )
  .build();
  public static final Flag COLLECT_WATER = new Flag.Builder(
    "COLLECT_WATER",
    Material.WATER_BUCKET
  )
    .mode(Flag.Mode.ADVANCED)
    .build();
  public static final Flag MILKING = new Flag.Builder("MILKING", Material.MILK_BUCKET)
    .mode(Flag.Mode.ADVANCED)
    .build();
  public static final Flag FISH_SCOOPING = new Flag.Builder(
    "FISH_SCOOPING",
  ...
  public static final Flag CHORUS_FRUIT = new Flag.Builder(
    "CHORUS_FRUIT",
    Material.CHORUS_FRUIT
  )
    .listener(new TeleportationListener())
    .build();
  public static final Flag ENDER_PEARL = new Flag.Builder(
    "ENDER_PEARL",
  ...
  public static final Flag CROP_TRAMPLE = new Flag.Builder("CROP_TRAMPLE", Material.WHEAT)
    .listener(new PhysicalInteractionListener())
    .build();
  public static final Flag PRESSURE_PLATE = new Flag.Builder(
    "PRESSURE_PLATE",
    Material.STONE_PRESSURE_PLATE
  )
    .mode(Flag.Mode.ADVANCED)
    .build();
  public static final Flag TURTLE_EGGS = new Flag.Builder(
    "TURTLE_EGGS",
    Material.TURTLE_EGG
  )
  .build();
   ...
   * @see EggListener
   */
  public static final Flag EGGS = new Flag.Builder("EGGS", Material.EGG)
    .listener(new EggListener())
    .build();
  /**
   ...
   */
  public static final Flag POTION_THROWING = new Flag.Builder(
    "POTION_THROWING",
   ...
   * @see ThrowingListener
   */
  public static final Flag EXPERIENCE_BOTTLE_THROWING = new Flag.Builder(
   ...
   * @see FireListener
   */
  public static final Flag FLINT_AND_STEEL = new Flag.Builder(
    "FLINT_AND_STEEL",
   ...
   * @see TNTListener
   */
  public static final Flag TNT_PRIMING = new Flag.Builder("TNT_PRIMING", Material.TNT)
   ...
   * @see FireListener
   */
  public static final Flag FIRE_EXTINGUISH = new Flag.Builder(
    "FIRE_EXTINGUISH",
    Material.POTION
  )
  .build();
  ...
  // Inventories
  public static final Flag MOUNT_INVENTORY = new Flag.Builder(
    "MOUNT_INVENTORY",
  ...
  // Hurting things
  public static final Flag HURT_ANIMALS = new Flag.Builder(
    "HURT_ANIMALS",
    Material.STONE_SWORD
  )
    .listener(new HurtingListener())
    .mode(Flag.Mode.ADVANCED)
    .build();
  public static final Flag HURT_MONSTERS = new Flag.Builder(
    "HURT_MONSTERS",
    Material.WOODEN_SWORD
  )
    .mode(Flag.Mode.BASIC)
    .build();
  public static final Flag HURT_VILLAGERS = new Flag.Builder(
    "HURT_VILLAGERS",
  ...
  // Leashes
  public static final Flag LEASH = new Flag.Builder("LEASH", Material.LEAD)
   ...
   * @see PortalListener
   */
  public static final Flag NETHER_PORTAL = new Flag.Builder(
    "NETHER_PORTAL",
    Material.NETHERRACK
  )
   ...
   * @see PortalListener
   */
  public static final Flag END_PORTAL = new Flag.Builder(
    "END_PORTAL",
  ...
  // Shearing
  public static final Flag SHEARING = new Flag.Builder("SHEARING", Material.SHEARS)
  ...
  public static final Flag ITEM_DROP = new Flag.Builder("ITEM_DROP", Material.DIAMOND)
    ...
    .mode(Flag.Mode.BASIC)
    .build();
  public static final Flag ITEM_PICKUP = new Flag.Builder(
    "ITEM_PICKUP",
    Material.SUGAR_CANE
  )
    .mode(Flag.Mode.BASIC)
  ...
  // Experience
  public static final Flag EXPERIENCE_PICKUP = new Flag.Builder(
    "EXPERIENCE_PICKUP",
    Material.EXPERIENCE_BOTTLE
  )
    .listener(
      Util.isPaper()
        ? new PaperExperiencePickupListener()
  ...
  // Command ranks
  public static final Flag COMMAND_RANKS = new Flag.Builder(
    "COMMAND_RANKS",
    Material.PLAYER_HEAD
  )
    .clickHandler(new CommandRankClickListener())
    .usePanel(true)
    .build();
   ...
   * @see DyeListener
   */
  public static final Flag DYE = new Flag.Builder("DYE", Material.LIGHT_BLUE_DYE)
    .listener(new DyeListener())
    .mode(Flag.Mode.ADVANCED)
    .build();
   ...
   * @since 1.6.0
   */
  public static final Flag ELYTRA = new Flag.Builder("ELYTRA", Material.ELYTRA)
    .defaultRank(RanksManager.VISITOR_RANK)
    .listener(new ElytraListener())
    .mode(Flag.Mode.ADVANCED)
    .build();

  // Island lock
  public static final Flag LOCK = new Flag.Builder("LOCK", Material.TRIPWIRE_HOOK)
    .defaultSetting(true)
    .defaultRank(RanksManager.VISITOR_RANK)
    .listener(new LockAndBanListener())
    .clickHandler(
      new CycleClick("LOCK", RanksManager.VISITOR_RANK, RanksManager.MEMBER_RANK)
    )
    .mode(Flag.Mode.TOP_ROW)
    .build();
   ...
   */
  // PVP
  public static final Flag PVP_OVERWORLD = new Flag.Builder(
    "PVP_OVERWORLD",
    Material.ARROW
  )
    .type(Type.SETTING)
    .defaultRank(DISABLED)
    .listener(new PVPListener())
    .cooldown(60)
    .mode(Flag.Mode.BASIC)
    .build();
  public static final Flag PVP_NETHER = new Flag.Builder("PVP_NETHER", Material.IRON_AXE)
    .type(Type.SETTING)
    .defaultRank(DISABLED)
    .cooldown(60)
    .mode(Flag.Mode.BASIC)
    .build();
  public static final Flag PVP_END = new Flag.Builder("PVP_END", Material.END_CRYSTAL)
    .type(Type.SETTING)
    .defaultRank(DISABLED)
    .cooldown(60)
    .mode(Flag.Mode.BASIC)
   ...
   * @see FireListener
   */
  public static final Flag FIRE_BURNING = new Flag.Builder(
    "FIRE_BURNING",
    Material.CHARCOAL
  )
    .defaultSetting(true)
   ...
   * @see FireListener
   */
  public static final Flag FIRE_IGNITE = new Flag.Builder(
    "FIRE_IGNITE",
    Material.FLINT_AND_STEEL
  )
    .defaultSetting(true)
   ...
   * @see FireListener
   */
  public static final Flag FIRE_SPREAD = new Flag.Builder(
    "FIRE_SPREAD",
   ...
   */
  @Deprecated
  public static final Flag ANIMAL_SPAWN = new Flag.Builder("ANIMAL_SPAWN", Material.APPLE)
    .defaultSetting(true)
    .type(Type.SETTING)
    .build();
   ...
   */
  @Deprecated
  public static final Flag MONSTER_SPAWN = new Flag.Builder(
    "MONSTER_SPAWN",
    Material.SPAWNER
  )
    .defaultSetting(true)
   ...
   */
  public static final Flag ANIMAL_NATURAL_SPAWN = new Flag.Builder(
   ...
   * @see MobSpawnListener
   */
  public static final Flag ANIMAL_SPAWNERS_SPAWN = new Flag.Builder(
   ...
   * @see MobSpawnListener
   */
  public static final Flag MONSTER_NATURAL_SPAWN = new Flag.Builder(
   ...
   * @see MobSpawnListener
   */
  public static final Flag MONSTER_SPAWNERS_SPAWN = new Flag.Builder(
   ...
   * @see DecayListener
   */
  public static final Flag LEAF_DECAY = new Flag.Builder(
    "LEAF_DECAY",
    Material.OAK_LEAVES
  )
    .type(Type.SETTING)
   ...
   * @see TNTListener
   */
  public static final Flag TNT_DAMAGE = new Flag.Builder("TNT_DAMAGE", Material.TNT)
    .type(Type.SETTING)
    .mode(Flag.Mode.ADVANCED)
    .build();
   ...
   * @see TNTListener
   */
  public static final Flag WORLD_TNT_DAMAGE = new Flag.Builder(
    "WORLD_TNT_DAMAGE",
    Material.TNT
  )
   ...
   */
  public static final Flag ENDER_CHEST = new Flag.Builder(
    "ENDER_CHEST",
  ...
  public static final Flag ENDERMAN_GRIEFING = new Flag.Builder(
    "ENDERMAN_GRIEFING",
  ...
  public static final Flag ENTER_EXIT_MESSAGES = new Flag.Builder(
    "ENTER_EXIT_MESSAGES",
    Material.DIRT
  )
    .defaultSetting(true)
  ...
  public static final Flag PISTON_PUSH = new Flag.Builder("PISTON_PUSH", Material.PISTON)
    .defaultSetting(true)
    .type(Type.WORLD_SETTING)
  ...
  public static final Flag INVINCIBLE_VISITORS = new Flag.Builder(
    "INVINCIBLE_VISITORS",
  ...
  public static final Flag GEO_LIMIT_MOBS = new Flag.Builder(
    "GEO_LIMIT_MOBS",
    Material.CHAINMAIL_CHESTPLATE
  )
    .type(Type.WORLD_SETTING)
    .listener(new GeoLimitMobsListener())
    .clickHandler(new GeoLimitClickListener())
    .usePanel(true)
    .build();
   ...
   * @since 1.12.0
   */
  public static final Flag LIMIT_MOBS = new Flag.Builder(
    "LIMIT_MOBS",
    Material.CHAINMAIL_BOOTS
  )
    .type(Type.WORLD_SETTING)
    .listener(new LimitMobsListener())
    .clickHandler(new MobLimitClickListener())
    .usePanel(true)
    .build();

  public static final Flag REMOVE_MOBS = new Flag.Builder(
    "REMOVE_MOBS",
    Material.GLOWSTONE_DUST
  )
    .type(Type.WORLD_SETTING)
    .listener(new RemoveMobsListener())
    .defaultSetting(true)
    .build();

  public static final Flag ITEM_FRAME_DAMAGE = new Flag.Builder(
    "ITEM_FRAME_DAMAGE",
    Material.ITEM_FRAME
  )
    .type(Type.WORLD_SETTING)
    .listener(new ItemFrameListener())
    .build();

  public static final Flag ISLAND_RESPAWN = new Flag.Builder(
    "ISLAND_RESPAWN",
    Material.TORCH
  )
    .type(Type.WORLD_SETTING)
    .listener(new IslandRespawnListener())
    .defaultSetting(true)
    .build();
   ...
   */
  public static final Flag OFFLINE_REDSTONE = new Flag.Builder(
    "OFFLINE_REDSTONE",
    Material.COMPARATOR
  )
    .type(Type.WORLD_SETTING)
    .listener(new OfflineRedstoneListener())
    .defaultSetting(true)
    .build();
   ...
   */
  public static final Flag OFFLINE_GROWTH = new Flag.Builder(
    "OFFLINE_GROWTH",
    Material.WHEAT_SEEDS
  )
    .type(Type.WORLD_SETTING)
    .listener(new OfflineGrowthListener())
    .defaultSetting(true)
    .build();

  public static final Flag CLEAN_SUPER_FLAT = new Flag.Builder(
    "CLEAN_SUPER_FLAT",
    Material.BEDROCK
  )
    .type(Type.WORLD_SETTING)
    .listener(new CleanSuperFlatListener())
    .build();

  public static final Flag CHEST_DAMAGE = new Flag.Builder(
    "CHEST_DAMAGE",
    Material.TRAPPED_CHEST
  )
    .type(Type.WORLD_SETTING)
    .listener(new ChestDamageListener())
    .build();
  public static final Flag CREEPER_DAMAGE = new Flag.Builder(
    "CREEPER_DAMAGE",
    Material.GREEN_SHULKER_BOX
  )
    .listener(new CreeperListener())
    .type(Type.WORLD_SETTING)
    .defaultSetting(true)
    .build();
  /**
   ...
   * @see CreeperListener
   */
  public static final Flag CREEPER_GRIEFING = new Flag.Builder(
    "CREEPER_GRIEFING",
  ...
  public static final Flag COARSE_DIRT_TILLING = new Flag.Builder(
    "COARSE_DIRT_TILLING",
    Material.COARSE_DIRT
  )
    .type(Type.WORLD_SETTING)
    .defaultSetting(true)
    .listener(new CoarseDirtTillingListener())
    .build();

  public static final Flag PREVENT_TELEPORT_WHEN_FALLING = new Flag.Builder(
  ...
  public static final Flag OBSIDIAN_SCOOPING = new Flag.Builder(
    "OBSIDIAN_SCOOPING",
    Material.OBSIDIAN
  )
    .type(Type.WORLD_SETTING)
   ...
   */
  public static final Flag LIQUIDS_FLOWING_OUT = new Flag.Builder(
    "LIQUIDS_FLOWING_OUT",
    Material.WATER_BUCKET
  )
    .type(Type.WORLD_SETTING)
    .listener(new LiquidsFlowingOutListener())
    .build();
   ...
   */
  public static final Flag REMOVE_END_EXIT_ISLAND = new Flag.Builder(
   ...
   */
  public static final Flag TREES_GROWING_OUTSIDE_RANGE = new Flag.Builder(
    "TREES_GROWING_OUTSIDE_RANGE",
    Material.OAK_SAPLING
  )
    .type(Type.WORLD_SETTING)
    .listener(new TreesGrowingOutsideRangeListener())
    .build();
   ...
   */
  public static final Flag NATURAL_SPAWNING_OUTSIDE_RANGE = new Flag.Builder(
   ...
   * @see WitherListener
   */
  public static final Flag WITHER_DAMAGE = new Flag.Builder(
    "WITHER_DAMAGE",
    Material.WITHER_SKELETON_SKULL
  )
    .listener(new WitherListener())
    .type(Type.WORLD_SETTING)
    .build();
   ...
   */
  public static final Flag SPAWNER_SPAWN_EGGS = new Flag.Builder(
    "SPAWNER_SPAWN_EGGS",
    Material.SPAWNER
  )
