...
public enum GameModePlaceholder {
  ...
  WORLD_ISLANDS(
    "world_islands",
    (addon, user, island) ->
      String.valueOf(addon.getIslands().getIslandCount(addon.getOverWorld()))
  ),
   ...
   * @since 1.5.0
   */
  ISLAND_DISTANCE_DIAMETER(
    "island_distance_diameter",
    (addon, user, island) ->
      String.valueOf(2 * addon.getWorldSettings().getIslandDistance())
  ),
  // ----------------------------------
  /**
  ...
  ISLAND_PROTECTION_RANGE(
    "island_protection_range",
    (addon, user, island) ->
      island == null ? "" : String.valueOf(island.getProtectionRange())
  ),
  /**
   * Returns the island's protection range as a diameter (it is therefore equivalent to twice the island protection range).
   * @since 1.5.0
   */
  ISLAND_PROTECTION_RANGE_DIAMETER(
    "island_protection_range_diameter",
    (addon, user, island) ->
      island == null ? "" : String.valueOf(2 * island.getProtectionRange())
  ),
  ISLAND_OWNER(
    "island_owner",
    (addon, user, island) ->
      island == null ? "" : addon.getPlayers().getName(island.getOwner())
  ),
  ...
  ISLAND_NAME(
    ...
    (addon, user, island) -> {
      ...
      if (island.getName() == null) {
        return user.getTranslation(
          island.getWorld(),
          "protection.flags.ENTER_EXIT_MESSAGES.island",
          TextVariables.NAME,
          addon.getPlayers().getName(island.getOwner())
        );
      }
  ...
  ISLAND_CENTER_X(
    "island_center_x",
    (addon, user, island) ->
      island == null ? "" : String.valueOf(island.getCenter().getBlockX())
  ),
  /**
  ...
  ISLAND_CENTER_Y(
    "island_center_y",
    (addon, user, island) ->
      island == null ? "" : String.valueOf(island.getCenter().getBlockY())
  ),
  /**
  ...
  ISLAND_CENTER_Z(
    "island_center_z",
    (addon, user, island) ->
      island == null ? "" : String.valueOf(island.getCenter().getBlockZ())
  ),
  /**
      ...
      island == null
        ...
        : String.valueOf(
          user.getPermissionValue(
            addon.getPermissionPrefix() + "team.maxsize",
            addon.getPlugin().getIWM().getMaxTeamSize(addon.getOverWorld())
          )
        )
  ),
  /**
   ...
   * @since 1.5.0
   */
  ISLAND_MEMBERS_COUNT(
    "island_members_count",
    (addon, user, island) ->
      island == null ? "" : String.valueOf(island.getMemberSet().size())
  ),
  /**
   ...
   * @since 1.5.0
   */
  ISLAND_VISITORS_COUNT(
    "island_visitors_count",
    (addon, user, island) ->
      island == null ? "" : String.valueOf(island.getVisitors().size())
  ),
  /**
  ...
  ISLAND_BANS_COUNT(
    "island_bans_count",
    (addon, user, island) ->
      island == null ? "" : String.valueOf(island.getBanned().size())
  ),
   ...
   * @since 1.5.2
   */
  VISITED_ISLAND_PROTECTION_RANGE(
    "visited_island_protection_range",
    (addon, user, island) -> {
      ...
      return visitedIsland
        .map(value -> String.valueOf(value.getProtectionRange()))
        .orElse("");
    }
  ),
  /**
   ...
   * @since 1.5.2
   */
  VISITED_ISLAND_PROTECTION_RANGE_DIAMETER(
    "visited_island_protection_range_diameter",
    (addon, user, island) -> {
      if (user == null || !user.isPlayer() || user.getLocation() == null) {
        return "";
      ...
      Optional<Island> visitedIsland = addon.getIslands().getIslandAt(user.getLocation());
      return visitedIsland
        .map(value -> String.valueOf(2 * value.getProtectionRange()))
        .orElse("");
    }
  ),
  /**
  ...
  VISITED_ISLAND_OWNER(
    ...
    (addon, user, island) -> {
      ...
      Optional<Island> visitedIsland = addon.getIslands().getIslandAt(user.getLocation());
      return visitedIsland
        .map(value -> addon.getPlayers().getName(value.getOwner()))
        .orElse("");
    }
  ),
  /**
      ...
      return visitedIsland
        .map(
          value ->
            DateFormat
              .getInstance()
              .format(Date.from(Instant.ofEpochMilli(value.getCreatedDate())))
        )
        .orElse("");
    }
  ),
  ...
  VISITED_ISLAND_CENTER(
    ...
    (addon, user, island) -> {
      ...
      Optional<Island> visitedIsland = addon.getIslands().getIslandAt(user.getLocation());
      return visitedIsland
        .map(value -> Util.xyz(value.getCenter().toVector()))
        .orElse("");
    }
  ),
  /**
  ...
  VISITED_ISLAND_CENTER_X(
    ...
    (addon, user, island) -> {
      ...
      Optional<Island> visitedIsland = addon.getIslands().getIslandAt(user.getLocation());
      return visitedIsland
        .map(value -> String.valueOf(value.getCenter().getBlockX()))
        .orElse("");
    }
  ),
  /**
  ...
  VISITED_ISLAND_CENTER_Y(
    ...
    (addon, user, island) -> {
      ...
      Optional<Island> visitedIsland = addon.getIslands().getIslandAt(user.getLocation());
      return visitedIsland
        .map(value -> String.valueOf(value.getCenter().getBlockY()))
        .orElse("");
    }
  ),
  /**
  ...
  VISITED_ISLAND_CENTER_Z(
    ...
    (addon, user, island) -> {
      ...
      Optional<Island> visitedIsland = addon.getIslands().getIslandAt(user.getLocation());
      return visitedIsland
        .map(value -> String.valueOf(value.getCenter().getBlockZ()))
        .orElse("");
    }
  ),
  /**
  ...
  VISITED_ISLAND_MEMBERS_COUNT(
    ...
    (addon, user, island) -> {
      ...
      Optional<Island> visitedIsland = addon.getIslands().getIslandAt(user.getLocation());
      return visitedIsland
        .map(value -> String.valueOf(value.getMemberSet().size()))
        .orElse("");
    }
  ),
  /**
  ...
  VISITED_ISLAND_TRUSTEES_COUNT(
    ...
    (addon, user, island) -> {
      ...
      return visitedIsland
        .map(
          value ->
            String.valueOf(value.getMemberSet(RanksManager.TRUSTED_RANK, false).size())
        )
        .orElse("");
    }
  ),
  ...
  VISITED_ISLAND_COOPS_COUNT(
    ...
    (addon, user, island) -> {
      ...
      return visitedIsland
        .map(
          value ->
            String.valueOf(value.getMemberSet(RanksManager.COOP_RANK, false).size())
        )
        .orElse("");
    }
  ),
  ...
  VISITED_ISLAND_VISITORS_COUNT(
    ...
    (addon, user, island) -> {
      ...
      Optional<Island> visitedIsland = addon.getIslands().getIslandAt(user.getLocation());
      return visitedIsland
        .map(value -> String.valueOf(value.getVisitors().size()))
        .orElse("");
    }
  ),
  /**
  ...
  VISITED_ISLAND_BANS_COUNT(
    ...
    (addon, user, island) -> {
      ...
      Optional<Island> visitedIsland = addon.getIslands().getIslandAt(user.getLocation());
      return visitedIsland
        .map(value -> String.valueOf(value.getBanned().size()))
        .orElse("");
    }
  ),
  ...
  RANK(
    "rank",
    (addon, user, island) ->
      (island == null || user == null)
        ? ""
        : user.getTranslation(
          addon.getPlugin().getRanksManager().getRank(island.getRank(user))
        )
  ),
  /**
  ...
  RESETS(
    ...
    (addon, user, island) ->
      String.valueOf(
        addon.getPlayers().getResets(addon.getOverWorld(), user.getUniqueId())
      )
  ),
  /**
  ...
  RESETS_LEFT(
    ...
    (addon, user, island) ->
      String.valueOf(
        addon.getPlayers().getResetsLeft(addon.getOverWorld(), user.getUniqueId())
      )
  ),
  /**
  ...
  DEATHS(
    ...
    (addon, user, island) ->
      String.valueOf(
        addon.getPlayers().getDeaths(addon.getOverWorld(), user.getUniqueId())
      )
  ),
  /**
  ...
  ON_ISLAND(
    "on_island",
    (addon, user, island) ->
      String.valueOf(addon.getIslands().userIsOnIsland(addon.getOverWorld(), user))
  ),
  /**
  ...
  OWNS_ISLAND(
    "owns_island",
    (addon, user, island) ->
      String.valueOf(island != null && user.getUniqueId().equals(island.getOwner()))
  );
