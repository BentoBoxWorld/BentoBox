...
public class ServerCompatibility {
  ...
  public enum ServerVersion {
     ...
     */
    @NonNull
    public static List<ServerVersion> getVersions(
  ...
  public Compatibility checkCompatibility() {
    if (result == null) {
      ...
      if (
        version == null || version.getCompatibility().equals(Compatibility.INCOMPATIBLE)
      ) {
      ...
      if (
        software.getCompatibility().equals(Compatibility.NOT_SUPPORTED) ||
      ...
      if (
        software.getCompatibility().equals(Compatibility.SUPPORTED) ||
