...
public abstract class BaseNMSAbstraction implements NMSAbstraction {
    ...
    @Override
    public CompletableFuture<Void> regenerateChunk(GameModeAddon gm, IslandDeletion di, World world, int chunkX, int chunkZ) {
