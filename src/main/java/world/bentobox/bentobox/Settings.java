...
public class Settings implements ConfigObject {
  ...
  @ConfigEntry(
    path = "island.cooldown.options.set-reset-cooldown-on-create",
    since = "1.2.0"
  )
  ...
  @ConfigComment(
    "It automatically transfers the ownership of an island to one of its members in case the current owner is inactive."
  )
  @ConfigComment(
    "More precisely, it transfers the ownership of the island to the player who's active, whose rank is the highest"
  )
  ...
  @ConfigComment(
    "Time in days since the island owner's last disconnection before they are considered inactive."
  )
  @ConfigEntry(
    path = "island.automated-ownership-transfer.inactivity-threshold",
    hidden = true
  )
  private int autoOwnershipTransferInactivityThreshold = 30;

  @ConfigComment(
    "Ranks are being considered when transferring the island ownership to one of its member."
  )
  @ConfigComment(
    "Ignoring ranks will result in the island ownership being transferred to the player who's active and"
  )
  ...
  @ConfigEntry(
    path = "web.updater.check-updates.bentobox",
    since = "1.3.0",
    hidden = true
  )
  ...
  public void setAutoOwnershipTransferInactivityThreshold(
    int autoOwnershipTransferInactivityThreshold
  ) {
    this.autoOwnershipTransferInactivityThreshold =
      autoOwnershipTransferInactivityThreshold;
  }
  ...
  public void setAutoOwnershipTransferIgnoreRanks(
    boolean autoOwnershipTransferIgnoreRanks
  ) {
