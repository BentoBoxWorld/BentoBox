...
public class IslandCreationPanel {
  ...
  public static void openPanel(
    ...
    for (BlueprintBundle bb : bbs) {
      ...
      if (
        bb.getUniqueId().equals(BlueprintsManager.DEFAULT_BUNDLE_NAME) ||
