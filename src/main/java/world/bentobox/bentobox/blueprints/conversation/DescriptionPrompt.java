...
public class DescriptionPrompt extends StringPrompt {
  ...
  public String getPromptText(ConversationContext context) {
    ...
    if (context.getSessionData(DESCRIPTION) != null) {
      ...
      for (String line : ((List<String>) context.getSessionData(DESCRIPTION))) {
        sb.append(
          user.getTranslation(
            "commands.admin.blueprint.management.description.default-color"
          )
        );
        sb.append(line);
    ...
    return user.getTranslation(
      "commands.admin.blueprint.management.description.instructions",
      TextVariables.NAME,
      bb.getDisplayName()
    );
  }
  ...
  public Prompt acceptInput(ConversationContext context, String input) {
    ...
    if (
      input.equals(
        user.getTranslation("commands.admin.blueprint.management.description.quit")
      )
    ) {
