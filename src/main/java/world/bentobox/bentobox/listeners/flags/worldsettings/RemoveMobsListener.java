...
public class RemoveMobsListener extends FlagListener {
  ...
  public void onUserTeleport(PlayerTeleportEvent e) {
    ...
    if (
      e.getCause().equals(TeleportCause.CHORUS_FRUIT) ||
      e.getCause().equals(TeleportCause.ENDER_PEARL) ||
    ...
    if (
      e.getTo().getWorld().equals(e.getPlayer().getWorld()) &&
      e.getTo().distanceSquared(e.getPlayer().getLocation()) <
    ...
    if (
      getIslands().locationIsOnIsland(e.getPlayer(), e.getTo()) &&
