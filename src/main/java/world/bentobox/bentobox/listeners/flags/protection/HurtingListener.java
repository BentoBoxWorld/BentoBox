...
public class HurtingListener extends FlagListener {
  ...
  public void onEntityDamage(final EntityDamageByEntityEvent e) {
    ...
    if (Util.isPassiveEntity(e.getEntity())) {
      ...
      e.getEntityType().name().equals("WANDERING_TRADER")
    ) { // TODO: Simplify when 1.13.2 support is dropped
  ...
  private void respond(EntityDamageByEntityEvent e, Entity damager, Flag flag) {
    ...
    if (damager instanceof Player) {
      ...
      if (
        ...
        !checkIsland(e, (Player) p.getShooter(), damager.getLocation(), flag)
      ) {
  ...
  public void onFishing(PlayerFishEvent e) {
    ...
    if (
      (
        Util.isPassiveEntity(e.getCaught()) &&
    ...
    if (
      e.getCaught() instanceof ArmorStand &&
  ...
  public void onPlayerFeedParrots(PlayerInteractEntityEvent e) {
    if (
      e.getRightClicked() instanceof Parrot &&
      (
  ...
  public void onLingeringPotionSplash(final LingeringPotionSplashEvent e) {
    ...
    if (
      !ServerCompatibility
        .getInstance()
        .isVersion(
          ServerCompatibility.ServerVersion.V1_14,
          ServerCompatibility.ServerVersion.V1_14_1
        )
    ) {
  ...
  public void onLingeringPotionDamage(final EntityDamageByEntityEvent e) {
    if (
      ...
      thrownPotions.containsKey(e.getDamager().getEntityId())
    ) {
  ...
  public void onFireworkDamage(final EntityDamageByEntityEvent e) {
    if (
      e.getDamager() instanceof Firework && firedFireworks.containsKey(e.getDamager())
    ) {
  ...
  public void onPlayerShootEvent(final EntityShootBowEvent e) {
    ...
    if (
      ...
      (e.getProjectile() instanceof Firework)
    ) {
