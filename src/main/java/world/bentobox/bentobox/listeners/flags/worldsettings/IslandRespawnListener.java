...
public class IslandRespawnListener extends FlagListener {
  ...
  public void onPlayerDeath(PlayerDeathEvent e) {
    ...
    if (
      !getIslands().hasIsland(world, e.getEntity().getUniqueId()) &&
  ...
  public void onPlayerRespawn(PlayerRespawnEvent e) {
    ...
    final Location respawnLocation = getIslands()
      .getSafeHomeLocation(
        Util.getWorld(world),
        User.getInstance(e.getPlayer().getUniqueId()),
        1
      );
    ...
    Util.runCommands(
      User.getInstance(e.getPlayer()),
      getIWM().getOnRespawnCommands(world),
      "respawn"
    );
  }
}
