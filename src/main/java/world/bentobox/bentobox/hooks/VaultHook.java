...
public class VaultHook extends Hook {
    ...
    /**
     * Gets balance of this User. If this User is not a Player (or OfflinePlayer),
     * it will always return {@code 0.0D}. If player is online, it should return the
     * balance of the world of the player If offline, it should return the general
     * balance
     *
    ...
    /**
     * Get balance of this User for this world. If this User is not a Player (or
     * OfflinePlayer), it will always return {@code 0.0D}. If the economy plugin
     * don't support world, it should return general balance
     * 
     * @param user  the User to get the balance from.
    ...
    /**
     * Withdraws an amount from this User. On the balance of the world where is the
     * user
     * 
     * @param user   the User to withdraw from. Must be a Player or an
     *               OfflinePlayer.
    ...
    /**
     * Withdraws an amount from this User on the balance from this World. If the
     * economy plugin don't support world or world is null, It will return general
     * balance.
     * 
     * @param user   the User to withdraw from. Must be a Player or an
     *               OfflinePlayer.
    ...
    /**
     * Deposits an amount to this User. On the balance of the world where is the
     * user
     * 
    ...
    /**
     * Deposits an amount to this User on the balance from this World. If the
     * economy plugin don't support world or world is null, It will return general
     * balance.
     * 
     * @param user   the User to deposit to. Must be a Player or an OfflinePlayer.
    ...
    /**
     * Checks if this User has the amount. On the balance of the world where is the
     * user If this User is not a Player (or OfflinePlayer), it will always return
     * {@code false}.
     *
    ...
    /**
     * Checks if this User has the amount on the balance from this World. If this
     * User is not a Player (or OfflinePlayer), it will always return {@code false}.
     * If the economy plugin don't support world or world is null, It will return
     * general balance.
     *
     * @param user   the User to check.
     * @param amount the amount to check. Must be positive.
