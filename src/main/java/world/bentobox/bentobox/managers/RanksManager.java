...
/**
 * Ranks Manager Handles ranks and holds constants for various island ranks
 * 
 * @author tastybento
 *
 */
public class RanksManager {
    ...
    /**
     * Try to add a new rank. Owner, member, visitor and banned ranks cannot be
     * changed.
     * 
    ...
    /**
     * Try to remove a rank. Owner, member, visitor and banned ranks cannot be
     * removed.
     * 
     * @param reference - a reference that can be found in a locale file
    ...
    /**
     * Gets the next rank value above the current rank. Highest is
     * {@link RanksManager#OWNER_RANK}
     * 
    ...
    /**
     * Gets the previous rank value below the current rank. Lowest is
     * {@link RanksManager#VISITOR_RANK}
     * 
     * @param currentRank - current rank value
     * @return Optional rank value
     */
