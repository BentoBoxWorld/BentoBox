...
public class PlaceholdersManager {
  ...
  public void registerPlaceholder(
    ...
    getPlaceholderAPIHook()
      .ifPresent(hook -> hook.registerPlaceholder(placeholder, replacer));
  }
  ...
  public void registerPlaceholder(
    ...
    // Register it in PlaceholderAPI
    getPlaceholderAPIHook()
      .ifPresent(hook -> hook.registerPlaceholder(addon, placeholder, replacer));
  }
  ...
  public void registerDefaultPlaceholders(@NonNull GameModeAddon addon) {
    Arrays
      .stream(GameModePlaceholder.values())
  ...
  public void unregisterPlaceholder(@Nullable Addon addon, @NonNull String placeholder) {
    ...
    // Unregister it from PlaceholderAPI
    getPlaceholderAPIHook()
      .ifPresent(hook -> hook.unregisterPlaceholder(addon, placeholder));
  }
  ...
  private Optional<PlaceholderAPIHook> getPlaceholderAPIHook() {
    return plugin
      .getHooks()
      .getHook("PlaceholderAPI")
      .map(hook -> (PlaceholderAPIHook) hook);
  }
  ...
  public boolean isPlaceholder(@NonNull Addon addon, @NonNull String placeholder) {
    return getPlaceholderAPIHook()
      .map(h -> h.isPlaceholder(addon, placeholder))
      .orElse(false);
  }
  ...
  public String replacePlaceholders(@NonNull Player player, @NonNull String string) {
    return getPlaceholderAPIHook()
      .map(papi -> papi.replacePlaceholders(player, string))
      .orElse(string);
  }
