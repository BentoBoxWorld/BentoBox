...
public class IslandEvent extends IslandBaseEvent {
  ...
  public static class IslandDeleteChunksEvent extends IslandBaseEvent {
    ...
    private IslandDeleteChunksEvent(
      Island island,
      UUID player,
      boolean admin,
      Location location,
  ...
  public static class IslandUnregisteredEvent extends IslandBaseEvent {
    ...
    private IslandUnregisteredEvent(
      Island island,
      UUID player,
      boolean admin,
      Location location
  ...
  public static class IslandProtectionRangeChangeEvent extends IslandBaseEvent {
     ...
     */
    private IslandProtectionRangeChangeEvent(
      Island island,
      UUID player,
      boolean admin,
      Location location,
  ...
  public static class IslandEventBuilder {
    ...
    public IslandBaseEvent build() {
      ...
      Bukkit
        .getPluginManager()
        .callEvent(new IslandEvent(island, player, admin, location, reason));
      ...
      switch (reason) {
        ...
        case PRECREATE:
          ...
          return precreate;
        case CREATE:
          IslandCreateEvent create = new IslandCreateEvent(
            island,
            player,
            admin,
            location,
          ...
          return create;
        case CREATED:
          IslandCreatedEvent created = new IslandCreatedEvent(
            island,
            player,
            admin,
            location
          ...
          return created;
        case DELETE:
          IslandDeleteEvent delete = new IslandDeleteEvent(
            island,
            player,
            admin,
            location
          ...
          return delete;
        case DELETE_CHUNKS:
          IslandDeleteChunksEvent deleteChunks = new IslandDeleteChunksEvent(
            island,
            player,
            admin,
            location,
          ...
          return deleteChunks;
        case DELETED:
          IslandDeletedEvent deleted = new IslandDeletedEvent(
            island,
            player,
            admin,
            location,
          ...
          return deleted;
        case ENTER:
          IslandEnterEvent enter = new IslandEnterEvent(
            island,
            player,
            admin,
            location,
          ...
          return enter;
        case EXIT:
          IslandExitEvent exit = new IslandExitEvent(
            island,
            player,
            admin,
            location,
        ...
        case LOCK:
          ...
          return lock;
        case RESET:
          IslandResetEvent reset = new IslandResetEvent(
            island,
            player,
            admin,
            location,
          ...
          return reset;
        case RESETTED:
          IslandResettedEvent resetted = new IslandResettedEvent(
            island,
            player,
            admin,
            location,
        ...
        case UNBAN:
          ...
          return unban;
        case UNLOCK:
          IslandUnlockEvent unlock = new IslandUnlockEvent(
            island,
            player,
            admin,
            location
          ...
          return unlock;
        case REGISTERED:
          IslandRegisteredEvent reg = new IslandRegisteredEvent(
            island,
            player,
            admin,
            location
          ...
          return reg;
        case UNREGISTERED:
          IslandUnregisteredEvent unreg = new IslandUnregisteredEvent(
            island,
            player,
            admin,
            location
          ...
          return unreg;
        case RANGE_CHANGE:
          IslandProtectionRangeChangeEvent change = new IslandProtectionRangeChangeEvent(
            island,
            player,
            admin,
            location,
          ...
          return change;
        case PRECLEAR:
          IslandPreclearEvent preclear = new IslandPreclearEvent(
            island,
            player,
            admin,
            location,
          ...
          return preclear;
        case RESERVED:
          IslandReservedEvent res = new IslandReservedEvent(
            island,
            player,
            admin,
            location
          ...
          return res;
        case RANK_CHANGE:
          IslandRankChangeEvent rankChange = new IslandRankChangeEvent(
            island,
            player,
            admin,
            location,
          ...
          return rankChange;
        default:
          IslandGeneralEvent general = new IslandGeneralEvent(
            island,
            player,
            admin,
            location
