...
public class AddonClassLoader extends URLClassLoader {
  ...
  public AddonClassLoader(
    ...
    throws InvalidAddonInheritException, MalformedURLException, InvalidDescriptionException, InvalidAddonDescriptionException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
  ...
  private AddonDescription asDescription(YamlConfiguration data)
    ...
    if (data.isConfigurationSection("permissions")) {
      builder.permissions(
        Objects.requireNonNull(data.getConfigurationSection("permissions"))
      );
    }
