...
public class HeadCache {
    ...
    /**
     * Time when head was created. Setting it to 0 will result in keeping head in
     * cache for ever.
     */
    ...
    /**
     * Returns a new Player head with a cached texture. Be AWARE, usage does not use
     * clone method. If for some reason item stack is stored directly, then use
     * clone in return :)
     *
