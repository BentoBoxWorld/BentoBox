...
public class HeadGetter {
    ...
    /**
     * This is main task that runs once every Settings#ticksBetweenCalls ticks and
     * tries to get Settings#headsPerCall player heads at once.
     *
     * @since 1.14.1
     */
    ...
    /**
     * This method gets and returns base64 encoded link to player skin texture from
     * mc-heads.net. It tries to use UUID if it is a valid, otherwise it uses given
     * username.
     *
