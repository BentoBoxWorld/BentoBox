...
/**
 * Serializes ItemStack to JSON and back. I'm going to cheat and use Bukkit's
 * built in YAML serializer/deserializer. This will have the best chance of
 * backwards compatibility with new server versions.
 * 
 * @author tastybento
 *
 */
public class ItemStackTypeAdapter extends TypeAdapter<ItemStack> {
    ...
    public ItemStack read(JsonReader reader) throws IOException {
        ...
        // Verify material type because yaml loading errors of unknown materials cannot
        // be trapped by try clause.
        if (n.contains("type:")) {
