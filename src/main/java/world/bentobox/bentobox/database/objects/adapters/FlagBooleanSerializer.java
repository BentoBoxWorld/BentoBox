...
/**
 * This Serializer migrates Map of String, Boolean to Map of String, Integer in
 * serialization process. It is necessary because current implementation
 * requires flags to be mapped to Integer value.
 * 
 * @author BONNe
 */
